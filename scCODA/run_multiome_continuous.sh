#!/bin/bash
# ==============================================================================
#   SLURM wrapper for sccoda_multiome_continuous.py. This is the fourth attempt's
#   configuration, the one that worked, with the tqdm and JAX threading workarounds
#   applied inside the Python script rather than here.
#
...
#SBATCH --job-name=sccoda_multiome_cont
...
"$ENV_PY" "$(pwd)/sccoda_multiome_continuous.py"
